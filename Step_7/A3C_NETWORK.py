...
class A3C_net_model:
    ...
    def _make_model(self):
        ...
        if PARA.Model == 'LSTM':
            hidden_layer = TimeDistributed(Dense(32), input_shape=self.input_shape)(in_put)
            hidden_layer = LSTM(16, return_sequences=True)(hidden_layer)
            hidden_layer = LSTM(8)(hidden_layer)
        elif PARA.Model == 'DNN':
